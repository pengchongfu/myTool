          ...
          <Navigator.NavigationBar
            routeMapper={{
              LeftButton: (route, navigator, index, navState) =>
                {
                  if(index===0){
                    ...
                    return (<View style={{height: 60, justifyContent: 'center', alignItems: 'center'}}>
              ...
              Title: (route, navigator, index, navState) =>
                { return (<View style={{height: 52, justifyContent: 'center', alignItems: 'center'}}><Text style={{fontSize: 20}}>{route.title}</Text></View>); },
            }}
